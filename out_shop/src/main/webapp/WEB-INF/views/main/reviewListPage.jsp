		  ...
		  <ul class="pagination">    
			...
			<c:choose>
				<c:when test="${requestScope.pageBean.previousPageGroup}">
					...
					<a class="page-link" href="${pageContext.request.contextPath}/reviewPage.do?page=1" aria-label="Previous">
				...
				<c:forEach begin="${requestScope.pageBean.beginPage}" end="${requestScope.pageBean.endPage}" var="page">
					<c:choose>
						<c:when test="${requestScope.pageBean.page != page}"> <%-- 현재패이지가 아니라면 --%>
							<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/reviewPage.do?page=${page}">${page}</a></li>
						</c:when>
						<c:otherwise>
			...
			<c:choose> 	
				<c:when test="${requestScope.pageBean.nextPageGroup}">
		    		...
		    		<a class="page-link" href="${pageContext.request.contextPath}/reviewPage.do?page=${requestScope.pageBean.endPage + 1}" aria-label="Next">
